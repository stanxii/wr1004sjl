 ...
 *   ihpapi.h
 *
 *   Encode buffer as an Intellon VS_RX_TONE_MAP_CHAR Management Message and
...
#ifndef GETRXTONEMAP_SOURCE
#define GETRXTONEMAP_SOURCE
...

{
	...
	* request = (struct vs_rx_tone_map_char_req *)(buffer);
	...
	offset += EncodeIntellonHeader (buffer + offset, bufferLen - offset, (VS_RX_TONE_MAP_CHAR | MMTYPE_REQ));
