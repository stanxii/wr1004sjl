...
{   
   ...
   //系统设置菜单
   wecSysSettings = insFld(foldersTree, gFld(getMenuTitle(MENU_WEC_SYS_SETTINGS), 'previewNetwork.cgi'));
   insFld(wecSysSettings, gFld(getMenuTitle(MENU_WEC_NTWK_SETTINGS), 'previewNetwork.cgi'));
