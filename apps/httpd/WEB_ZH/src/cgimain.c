...
{	
	if( ret == 0 )
	{
		...
		fprintf(fs, "<tr><td class='maintitle'><b>软件升级</b></td>\n</tr>\n</table>\n");
		fprintf(fs, "<table border=0 cellpadding=0 cellspacing=0>\n<tr>\n");
		fprintf(fs, "<td class='mainline' width=800></td>\n</tr>\n</table>\n");
		fprintf(fs, "<br>软件升级处理中，该过程大约需要2分钟时间，请耐心等待。\n");
		fprintf(fs, "<br><font color='red'>警告：</font>软件升级期间，请您千万不要进行其他操作，更不要切断电源！</br>\n");
		fprintf(fs, "<br><br>\n");		
		fprintf(fs, "<table border=0 cellpadding=3 cellspacing=0>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td width=300>正在准备系统资源</td>\n");
	...
	else
	{
		...
		fprintf(fs, "		<td width=300>正在准备系统资源</td>\n");
		fprintf(fs, "		<td width=80>......</td>\n");
		fprintf(fs, "		<td width=100>[<font color='red'>失败</font>]</td>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "</table>\n");
		fprintf(fs, "</form>\n</blockquote>\n</body>\n</html>\n");
		fflush(fs);
...
{	
	if( ret == 0 )
	{
		...
		fprintf(fs, "		<td width=300>正在准备系统资源</td>\n");
		fprintf(fs, "		<td width=80>......</td>\n");
		fprintf(fs, "		<td width=100>[<font color='green'>成功</font>]</td>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td>正在下载升级文件</td>\n");
		fprintf(fs, "		<td>......</td>\n");
...
{	
	if( ret == 0 )
	{
		...
		fprintf(fs, "		<td>正在下载升级文件</td>\n");
		fprintf(fs, "		<td>......</td>\n");
		fprintf(fs, "		<td>[<font color='green'>成功</font>]</td>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td>正在进行升级文件电子签名校验</td>\n");
		fprintf(fs, "		<td>......</td>\n");
		fprintf(fs, "		<td>[<IMG src='wait.gif'>]</td>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "</table>\n");
	...
	else
	{
		...
		fprintf(fs, "		<td>正在下载升级文件</td>\n");
		fprintf(fs, "		<td>......</td>\n");
		fprintf(fs, "		<td>[<font color='red'>失败</font>]</td>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "</table>\n");
		fprintf(fs, "</form>\n</blockquote>\n</body>\n</html>\n");
		fflush(fs);
...
{	
	...
	else
	{
		...
		fprintf(fs, "	<tr>\n");	
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td><font color='red'>软件升级操作失败</font></td>\n");
		fprintf(fs, "		<td>&nbsp;</td>\n");
		fprintf(fs, "		<td>&nbsp;</td>\n");
		fprintf(fs, "	<tr>\n");	
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td>系统正在重新启动，请耐心等待</td>\n");
		fprintf(fs, "		<td>......</td>\n");
		fprintf(fs, "		<td>[<IMG src='wait.gif'>]</td>\n");
		fprintf(fs, "	<tr>\n");	
		fprintf(fs, "</table>\n");
...
{	
	if( ret == 0 )
	{
		...
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td>正在将升级文件从内存写入存储器中</td>\n");
		fprintf(fs, "		<td>......</td>\n");
		fprintf(fs, "		<td>[<IMG src='wait.gif'>]</td>\n");
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "</table>\n");
...
{	
	if( ret == 0 )
	{
		...
		fprintf(fs, "	<tr>\n");	
		fprintf(fs, "	<tr>\n");
		fprintf(fs, "		<td><font color='green'>软件升级操作成功</font></td>\n");
		fprintf(fs, "		<td>&nbsp;</td>\n");
		fprintf(fs, "		<td>&nbsp;</td>\n");
		fprintf(fs, "	<tr>\n");	
		fprintf(fs, "	<tr>\n");
