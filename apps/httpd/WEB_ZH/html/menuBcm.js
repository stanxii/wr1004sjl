...
{   
	...
	//模板管理菜单
	wecTemplateMgmt = insFld(foldersTree, gFld(getMenuTitle(MENU_WEC_TEMPLATE_MGMT), 'previewTemplate.cgi'));
	insFld(wecTemplateMgmt, gFld(getMenuTitle(MENU_WEC_TEMPLATE_MGMT), 'previewTemplate.cgi'));
	insFld(wecTemplateMgmt, gFld(getMenuTitle(MENU_WEC_TEMPLATE_EDIT), 'mgmtTemplate.cgi?isupdate=0&templateid=1&col_tempAutoSts=88'));
